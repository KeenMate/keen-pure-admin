defmodule PureAdmin.Components.ListTest do
  ...
  describe "basic_list/1" do
    test "renders default list" do
      html = render_component(&List.basic_list/1, %{
        spacing: nil, is_bordered: false, is_striped: false, is_inline: false,
        is_unstyled: false, has_icon: false, icon_variant: nil, class: nil,
    ...
    test "renders compact spacing" do
      html = render_component(&List.basic_list/1, %{
        spacing: "compact", is_bordered: false, is_striped: false, is_inline: false,
        is_unstyled: false, has_icon: false, icon_variant: nil, class: nil,
        inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "<li>Item</li>" end}]
      })
    ...
    test "renders bordered and striped" do
      html = render_component(&List.basic_list/1, %{
        spacing: nil, is_bordered: true, is_striped: true, is_inline: false,
        is_unstyled: false, has_icon: false, icon_variant: nil, class: nil,
        inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "<li>Item</li>" end}]
      })
  ...
  describe "list_item/1" do
    test "renders with title_text and meta_text" do
      html = render_component(&List.list_item/1, %{
        title_text: "API Services", subtitle_text: nil, meta_text: "Operational",
        class: nil, avatar: [], meta: [],
        inner_block: []
      })
    ...
    test "renders custom inner_block content" do
      html = render_component(&List.list_item/1, %{
        title_text: nil, subtitle_text: nil, meta_text: nil,
        class: nil, avatar: [], meta: [],
