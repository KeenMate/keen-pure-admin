defmodule PureAdmin.Components.CalloutTest do
  ...
  describe "callout/1" do
    test "renders with default variant" do
      html = render_component(&Callout.callout/1, %{
        variant: "info", size: nil, theme_color: nil, heading_text: nil, class: nil,
        icon: [], title: [], inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "Note" end}]
      })
    ...
    test "renders all semantic variants" do
      for variant <- ~w(primary secondary info success warning danger) do
        html = render_component(&Callout.callout/1, %{
          variant: variant, size: nil, theme_color: nil, heading_text: nil, class: nil,
          icon: [], title: [], inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "text" end}]
        })
    ...
    test "renders theme color" do
      html = render_component(&Callout.callout/1, %{
        variant: "info", size: nil, theme_color: "3", heading_text: nil, class: nil,
        icon: [], title: [], inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "text" end}]
      })
    ...
    test "renders sizes" do
      for size <- ~w(sm lg) do
        html = render_component(&Callout.callout/1, %{
          variant: "info", size: size, theme_color: nil, heading_text: nil, class: nil,
          icon: [], title: [], inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "text" end}]
        })
    ...
    test "renders heading_text" do
      html = render_component(&Callout.callout/1, %{
        variant: "info", size: nil, theme_color: nil, heading_text: "Important", class: nil,
        icon: [], title: [], inner_block: [%{__slot__: :inner_block, inner_block: fn _, _ -> "text" end}]
      })
