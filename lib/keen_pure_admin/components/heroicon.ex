defmodule PureAdmin.Components.Heroicon do
  ...
  The SVG inherits color from the parent via `stroke="currentColor"`.
  ...
  def heroicon(%{name: "rocket-launch"} = assigns) do
    ~H"""
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" class={@class} {@rest}>
  ...
  def heroicon(%{name: name} = assigns) when is_binary(name) do
    ...
    ~H"""
    <span class={["heroicon-missing", @class]} title={"Unknown heroicon: " <> @missing} {@rest}></span>
    """
  end
end
