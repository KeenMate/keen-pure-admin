 ...
 *
 * The core IIFE exposes `window.pureAdmin.components.splitter = { init, initAll }` and
...
const splitter = () =>
  window.pureAdmin && window.pureAdmin.components && window.pureAdmin.components.splitter
