/**
 * pa_stat_fit_core.js — verbatim port of `@keenmate/pure-admin-core`
 * `src/js/pa-stat-fit.js` (v2.9.0-rc04). Kept byte-for-byte identical to the
 * upstream IIFE below the docblock so the fit-to-box behaviour matches the
 * framework exactly; the thin Phoenix hook lives in `pa_stat_fit.js` and
 * calls the `window.PaStatFit` API this file exposes. Do not edit — re-port
 * from upstream on version bumps (mirrors the `splitter_core.js` pattern).
 */
/* ============================================================================
