/**
 * Pure Admin — Container Breakpoint (element-width → named mode, event-driven)
 *
 ...
 *   var handle = window.pureCss.components.containerBreakpoint.observe(el, {
 ...
 *   </div>
 *
 *   window.pureCss.components.containerBreakpoint.initAll();   // or .init(el)
 *
 ...
 * via window.pureCss.config.containerBreakpoint.hiddenClass. Elements without
